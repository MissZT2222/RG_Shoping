...
@Data
@TableName("goods_spu")
//自动生成的equals和hashCode方法没有调用父类，如果是故意不掉用父类的话，可以加上@EqualsAndHashCode(callSuper=false)注解。
...
private static final long serialVersionUID = 1L;
   ...
   */
	...
	// 需要考虑数据库的字段设计,数据库中的int类型的,所以存不进去,但因为主键自增,
	// 如果要修改int类型为varchar类型的话,需要去除主键自增。
